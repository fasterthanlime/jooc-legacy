...
public class SourceContext {
    ...
    private final List<SourceContext> dependencies;
	...
	private final Stack<SyntaxNodeList> stack;
	private SyntaxNode lastClosed;
	
    private final SyntaxNodeList pathboundIncludes;
    private final SyntaxNodeList localIncludes;
    private final SyntaxNodeList dependencyGroup;
    
    private final Map<String, Define> defineSymbols;
	...
	private void addGCSupport(FileLocation location, SourceInfo info) {
